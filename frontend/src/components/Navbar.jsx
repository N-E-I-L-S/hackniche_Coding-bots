...
export default function Navbar() {
    ...
    return (
        <nav className="flex items-center justify-between flex-wrap -z-10 bg-green-cus-1 px-5 py-2 mx-3 rounded-lg backdrop-blur-sm -mt-14">
            ...
            <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto ml-5">
                <div className="text-sm lg:flex-grow">
                    <NavLink to="/home" className="block mt-1 lg:inline-block lg:mt-0 text-green-cus-2 hover:text-black hover:bg-green-cus-2 hover:rounded-md mr-4 text-lg p-2">
                        Home
                    </NavLink>
